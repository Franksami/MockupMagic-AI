...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-primary-900">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          <Link
            href="/studio"
            className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-indigo-500 via-primary-500 to-pink-500 text-white font-semibold text-lg rounded-xl hover:opacity-90 transition-all transform hover:scale-105 shadow-2xl"
