          ...
          <div className="flex gap-2" data-testid="sort-dropdown">
            <button
              ...
              className={cn(
                ...
                sortBy === 'popular' ? 'bg-purple-500/20 text-purple-400' : 'text-gray-400 hover:text-white'
              )}
              title="Most Popular"
            ...
            <button
              ...
              className={cn(
                'p-2 rounded-lg transition-all',
                sortBy === 'rating' ? 'bg-purple-500/20 text-purple-400' : 'text-gray-400 hover:text-white'
              )}
              title="Highest Rated"
            ...
            <button
              ...
              className={cn(
                'p-2 rounded-lg transition-all',
                sortBy === 'newest' ? 'bg-purple-500/20 text-purple-400' : 'text-gray-400 hover:text-white'
              )}
              title="Newest"
            >
